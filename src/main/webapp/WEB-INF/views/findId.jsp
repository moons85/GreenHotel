  ...
  <div class="container">
    <div class="row no-gutters slider-text align-items-center justify-content-center">
      <div class="col-md-9 ftco-animate text-center">
        <p class="breadcrumbs mb-2"><span class="mr-2"><a href="/">Home <i class="fa fa-chevron-right"></i></a></span> <span>Account <i class="fa fa-chevron-right"></i></span></p>
                ...
                <div class="row row2">
                  <div class="col-md-9">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="phonenumber" id="phonenumber" placeholder="가입시 사용한 전화번호를 입력해주세요.">
                    </div>
                  </div>
                  <div class="col-md-9">
                    <div class="form-group">
                  ...
                  <div class="col-md-3">
                    <button type="button" class="btn btn-primary idcheckbtn" id="rcode">아이디 찾기</button>
                  </div>
                  <!-- 시작: 아이디 검색 후 띄워주고, 그 전까지는 숨겨두기.-->
                  <div class="col-md-12 idvalue">
                    <!--아이디 없을 때: 해당 메일로 가입된 아이디를 찾을 수 없습니다.-->
                  </div>
                  <!-- 끝: 아이디 검색 후 띄워주고, 그 전까지는 숨겨두기.-->
