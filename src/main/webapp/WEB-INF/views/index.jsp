...
<div class="modal">
    <div class="modal_body">
        ...
        <div class="select_wrap">
            <input type="button" class="select_btn" value="1"> <input
                type="button" class="select_btn" value="2"> <input
                type="button" class="select_btn" value="3"> <input
                type="button" class="select_btn" value="4"> <input
                type="button" class="select_btn" value="5"> <input
                type="button" class="select_btn" value="6"> <input
                type="button" class="select_btn" value="7"> <input
                type="button" class="select_btn" value="8"> <input
                type="button" class="select_btn" value="9">
        </div>
...
<c:choose>
    ...
    <c:otherwise>
        <div style="position: fixed; top: 90vh; left: 90vw; z-index: 999">

            <input type="hidden" id="chatUser" value="${principal.user}">
            <input type="hidden" id="chatUserId" value="${principal.user.id}">
            <button id="createRoom" style="width: 50px; height: 50px; cursor: pointer;background: none;border: none;">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M256 48C141.1 48 48 141.1 48 256v40c0 13.3-10.7 24-24 24s-24-10.7-24-24V256C0 114.6 114.6 0 256 0S512 114.6 512 256V400.1c0 48.6-39.4 88-88.1 88L313.6 488c-8.3 14.3-23.8 24-41.6 24H240c-26.5 0-48-21.5-48-48s21.5-48 48-48h32c17.8 0 33.3 9.7 41.6 24l110.4 .1c22.1 0 40-17.9 40-40V256c0-114.9-93.1-208-208-208zM144 208h16c17.7 0 32 14.3 32 32V352c0 17.7-14.3 32-32 32H144c-35.3 0-64-28.7-64-64V272c0-35.3 28.7-64 64-64zm224 0c35.3 0 64 28.7 64 64v48c0 35.3-28.7 64-64 64H352c-17.7 0-32-14.3-32-32V240c0-17.7 14.3-32 32-32h16z" fill="#FEDA63"/></svg>
            </button>
        </div>
    </c:otherwise>
</c:choose>
...
<script type="text/javascript">
    ...
    createRoom.addEventListener('click', () => {
        var win = window.open("/chat/"+$("#chatUserId").val(), "PopupWin", "width=500,height=500");
        let data = {
        ...
        $.ajax({
            ...
            datatype: "json"
             ...
             location.replace("/chat/"+$("#chatUserId").val())
        ...
        <div class="row">
            <div
                ...
                <div class="d-block services-wrap text-center">
                    <div class="img"
                         style="background-image: url(/images/services-4.jpg);"></div>
            ...
            <div
                ...
                <div class="d-block services-wrap text-center">
                    <div class="img"
                         style="background-image: url(/images/services-5.jpg);"></div>
                    <div class="media-body py-4 px-3">
            ...
            <div
                ...
                <div class="d-block services-wrap text-center">
                    <div class="img"
                         style="background-image: url(/images/services-9.jpg);"></div>
                    <div class="media-body py-4 px-3">
        ...
        <div class="row no-gutters">
            <div class="col-md-6 wrap-about">
                <div class="img img-2 mb-4"
                     style="background-image: url(images/about2.png);"></div>
                <h2 class="h2_title">Private Hotel이 선물하는 특별한 일상</h2>
                <p>번화가 사이에서 쉼없이 열심히 살아가는 우리들을 위한 공간, 이 곳에서는 일상을 잠시 내려두고 편안한 휴식을
                    취해보세요. 가족과의 여행, 연인과의 하루, 친구들과의 모임 등 다양한 이유로 머무르는 당신을 Private Hotel은
                    항상 환영합니다.</p>
            </div>
            <div class="col-md-6 wrap-about ftco-animate">
                ...
                <div class="pl-md-5">
                    <p>낯선 공간에서 몸을 뉘이고 편히 쉬실 수 있도록 고객 여러분의 편의를 위해 최선을 다해 노력하는
                        Private Hotel이 되겠습니다. 언제나 저희 Private hotel을 믿고 이용해주셔서 감사합니다.</p>
                    <div class="row">
                        <div class="services-2 col-lg-6 d-flex w-100">
                            <div
                                    class="icon d-flex justify-content-center align-items-center">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                     viewBox="-320 -260 1100 1100">
                        ...
                        <div class="services-2 col-lg-6 d-flex w-100">
                            <div
                                    class="icon d-flex justify-content-center align-items-center">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                     viewBox="-280 -320 1200 1200">
                                    <!--! Font Awesome Pro 6.2.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
                                    <path style="fill:#fff;"
                                          d="M54.2 202.9C123.2 136.7 216.8 96 320 96s196.8 40.7 265.8 106.9c12.8 12.2 33 11.8 45.2-.9s11.8-33-.9-45.2C549.7 79.5 440.4 32 320 32S90.3 79.5 9.8 156.7C-2.9 169-3.3 189.2 8.9 202s32.5 13.2 45.2 .9zM320 256c56.8 0 108.6 21.1 148.2 56c13.3 11.7 33.5 10.4 45.2-2.8s10.4-33.5-2.8-45.2C459.8 219.2 393 192 320 192s-139.8 27.2-190.5 72c-13.3 11.7-14.5 31.9-2.8 45.2s31.9 14.5 45.2 2.8c39.5-34.9 91.3-56 148.2-56zm64 160c0-35.3-28.7-64-64-64s-64 28.7-64 64s28.7 64 64 64s64-28.7 64-64z" /></svg>
                            </div>
                            <div class="media-body pl-3">
        ...
        <div class="row d-flex">
            <div class="col-md-4 d-flex ftco-animate">
                <div class="blog-entry align-self-stretch">
                    ...
                    <div class="text p-4 text-center">
                        <h3 class="heading">
                            <a href="#">Private Hotel 오픈 기념 쿠폰 뽑기</a>
                        </h3>
                        <div class="meta mb-2">
                            <c:choose>
                                <c:when test="${empty principal}">
                                ...
                                <c:otherwise>
                                    ...
                                    <p class="text-descrandom">
                                        *1인당 참여제한이 1회 있습니다. <br>*당첨 쿠폰은 3개월 이내로 사용이 가능합니다.
                                    </p>
                                </c:otherwise>
                            </c:choose>
                        </div>
                        <p>이벤트 참여 및 이용에 관한 자세한 문의는 Private Hotel 문의 센터를 이용해주시기 바라며,
                            이벤트 상품의 경우 별도 환불이 어려움을 사전 안내드리는 바입니다.</p>
                    </div>
            ...
            <div class="col-md-4 d-flex ftco-animate">
                <div class="blog-entry align-self-stretch">
                    ...
                    <div class="text p-4 text-center">
                        <h3 class="heading">
                            <a href="/auth/tour">호텔 주변 관광지를 소개해 드립니다.</a>
                        </h3>
                        <div class="meta mb-2">
                            <div>
                                <a href="/auth/tour" class="nav-link btn btn-primary text-light">지금 바로 보러 가기</a>
                            </div>

                            <p><br>호텔에 머무르며 구경하기 좋은 관광지를 알아보세요. 데이트 코스부터 가족 단위로 즐기기 좋은 곳까지 다양한 관광지를 둘러보실 수 있습니다. 도보 및 대중교통, 길찾기 정보도 한 번에 함께 알아보세요. </p>
                        </div>
