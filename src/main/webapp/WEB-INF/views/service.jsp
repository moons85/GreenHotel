...
<section class="hero-wrap hero-wrap-2" style="background-image: url(/images/room-9.png);" data-stellar-background-ratio="0.5">
  <div class="overlay"></div>
  <div class="container">
    <div class="row no-gutters slider-text align-items-center justify-content-center">
      <div class="col-md-9 ftco-animate text-center">
        <p class="breadcrumbs mb-2"><span class="mr-2"><a href="/">Home <i class="fa fa-chevron-right"></i></a></span> <span>Services <i class="fa fa-chevron-right"></i></span></p>
...
<section class="ftco-section bg-light">
  <div class="container">
    <div class="row">
      <div class="col-md-4 d-flex services align-self-stretch px-4 ftco-animate">
        <div class="d-block services-wrap text-center">
          ...
          <div class="media-body py-4 px-3">
            ...
            <p><span class="price2">₩30,000</span></p>
      ...
      <div class="col-md-4 d-flex services align-self-stretch px-4 ftco-animate">
        <div class="d-block services-wrap text-center">
          ...
          <div class="media-body py-4 px-3">
            ...
            <p><span class="price2">₩10,000</span></p>
      ...
      <div class="col-md-4 d-flex services align-self-stretch px-4 ftco-animate">
        <div class="d-block services-wrap text-center">
          ...
          <div class="media-body py-4 px-3">
            <h3 class="heading">체크인, 체크아웃 시간 변경</h3>
            <p>이른 체크인 또는 늦은 체크아웃을 원하시는 분들을 위한 서비스입니다. 3시간까지 조정이 가능합니다.</p>
            <p><span class="price2">₩50,000</span></p>
    ...
    <div class="row">
      <div class="col-md-4 d-flex services align-self-stretch px-4 ftco-animate">
        <div class="d-block services-wrap text-center">
          <div class="img" style="background-image: url(/images/services-8.jpg);"></div>
          <div class="media-body py-4 px-3">
            <h3 class="heading">룸서비스</h3>
            <p>안락한 룸 안에서 원하는 음식을 주문할 수 있는 룸서비스입니다. 고급 스테이크부터 가벼운 와인 한 잔까지, 방 안에서 즐겨보세요. </p>
            <p><span class="price2"> 별도 문의</span></p>
      ...
      <div class="col-md-4 d-flex services align-self-stretch px-4 ftco-animate">
        <div class="d-block services-wrap text-center">
          ...
          <div class="media-body py-4 px-3">
            ...
            <p><span class="price2">₩80,000</span></p>
      ...
      <div class="col-md-4 d-flex services align-self-stretch px-4 ftco-animate">
        <div class="d-block services-wrap text-center">
          <div class="img" style="background-image: url(/images/services-10.jpg);"></div>
          <div class="media-body py-4 px-3">
            <h3 class="heading">침대 추가</h3>

            <p>침대가 부족한 분들을 위해 침대를 추가할 수 있는 서비스입니다. 방에 따라 침대 추가가 불가할 수 있습니다.</p>
            <p><span class="price2">₩50,000</span></p>
...
<section class="ftco-section bg-light ftco-no-pt">
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="services-2 col-md-3 d-flex w-100 ftco-animate">
        <div class="icon d-flex justify-content-center align-items-center">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="-280 -320 1200 1200"><!--! Font Awesome Pro 6.2.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path  style="fill:#fff;"  d="M54.2 202.9C123.2 136.7 216.8 96 320 96s196.8 40.7 265.8 106.9c12.8 12.2 33 11.8 45.2-.9s11.8-33-.9-45.2C549.7 79.5 440.4 32 320 32S90.3 79.5 9.8 156.7C-2.9 169-3.3 189.2 8.9 202s32.5 13.2 45.2 .9zM320 256c56.8 0 108.6 21.1 148.2 56c13.3 11.7 33.5 10.4 45.2-2.8s10.4-33.5-2.8-45.2C459.8 219.2 393 192 320 192s-139.8 27.2-190.5 72c-13.3 11.7-14.5 31.9-2.8 45.2s31.9 14.5 45.2 2.8c39.5-34.9 91.3-56 148.2-56zm64 160c0-35.3-28.7-64-64-64s-64 28.7-64 64s28.7 64 64 64s64-28.7 64-64z"/></svg>		              </div>            <div class="media-body pl-3">
