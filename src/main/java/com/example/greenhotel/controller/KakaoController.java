...
import com.example.greenhotel.model.KakaoToken;
...
public class KakaoController {
    ...
    public String kakaoToken(String code, Model model) {
        ...
        params.add("client_id", "9087b45cc0614d0db706baf5b2bedb62");
        params.add("redirect_uri", "http://localhost:8081/auth/kakao/login");
